...
public class MyBatisTest {
	...
	public void testBatchSave() throws IOException{
		...
		try{
			...
			emps.add(new Employee(null, "smith0x1", "smith0x1@lhyf.org", "1",new Department(1)));
			emps.add(new Employee(null, "allen0x1", "allen0x1@lhyf.org", "0",new Department(1)));
			mapper.addEmps(emps);
			openSession.commit();
		}finally{
			openSession.close();
